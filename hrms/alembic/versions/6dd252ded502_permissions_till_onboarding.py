"""permissions till onboarding

Revision ID: 6dd252ded502
Revises: 
Create Date: 2026-03-11 10:24:33.961122
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('employee_id', sa.Integer(), nullable=True),
    sa.Column('training_title', sa.String(length=150), nullable=True),
