...
Revision ID: 56dbcd89b0a2
Revises: 
Create Date: 2026-03-19 17:32:00.735525
...
def upgrade() -> None:
    ...
    sa.Column('personal_email', sa.String(length=150), nullable=False),
    ...
    sa.Column('invite_expiry', sa.DateTime(), nullable=True),
    ...
    op.create_index(op.f('ix_trainings_deleted_at'), 'trainings', ['deleted_at'], unique=False)
    ...
    op.create_index(op.f('ix_training_assignments_deleted_at'), 'training_assignments', ['deleted_at'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_training_assignments_deleted_at'), table_name='training_assignments')
    ...
    op.drop_index(op.f('ix_trainings_deleted_at'), table_name='trainings')
